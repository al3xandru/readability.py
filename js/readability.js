    ...
    **/
    ...
    getConfigurationFooter: function() {
        ...
        confFooter.innerHTML = [
            ...
            '<button type="button" value="Margin" onclick="readability.updateMargin(document.getElementById(\'readability-margin-conf\').value);return false"/>',
            '</p>',
            '<p>',
            '<b>Size</b> (x-small, small, medium, large, x-large):',
            '<input type="text" name="readability-size-conf" id="readability-size-conf" />',
            '<button type="button" value="Size" onclick="readability.updateSize(document.getElementById(\'readability-size-conf\').value);return false"/>',
            '</p>',
            ...
            '<button type="button" value="Style" onclick="readability.updateStyle(document.getElementById(\'readability-style-conf\').value);return false"/>',
            '</p>',
            '</div>',
            '</div>'            
        ].join('');
